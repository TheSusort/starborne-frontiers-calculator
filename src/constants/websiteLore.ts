...
export const WEBSITE_LORE: LoreArticle[] = [
    {
        title: 'Enemy Territory',
        slug: 'enemy-territory',
        body: `"-Anton, mostly just stand back and look impressive."
...
R&D turned away without another word, Whittaker stepping in front of her exit. Anton just watched her go, feeling the storm cloud brewing around Esandra next to him, until Arm Alpha pinged an alert and security stepped into the room behind them.`,
        sourceUrl: 'https://starborne.com/post/enemy-territory',
    },
    {
...
"You're too familiar, Espowyes," she said. "But tell me more, and we'll see how long you last."`,
        sourceUrl: 'https://starborne.com/post/a-lifetime-opportunity',
    },
    {
        title: 'Binderburg - History',
        slug: 'binderburg_lore_part2',
        body: `## History:

The original Binderburg Corporation was founded in 2090 as a provider of space-based agricultural installations and habitation systems. Over the span of several decades it became a leading megacorporation on and above Earth and Luna, fueled by increasing demands for its products during the expansionist drive of the Lunar Silver Age.
...
It is no surprise then, given what we know of the Conglomerate's interests, that they were among the first megacorporations to send scouts to the Spiral Expanse following the emergence of the Time-Space anomaly known as "The Abyss". While no established Binderburg facilities have been found in the area, and they have so far abided by the blockade established around the Abyss, it cannot be doubted that at the very least the Conglomerate's R&D department has taken an interest.`,
        sourceUrl: 'https://starborne.com/post/binderburg_lore_part2',
    },
    {
        title: 'Binderburg - Background Briefing',
        slug: 'binderburg_lore_part1',
...
While in recent history it has been a rare occurrence for pilots to battle Binderburg forces and survive to report their observations, the Conglomerate has been known in the past to possess surprisingly bleeding-edge weaponry. This is no doubt due to the specific influence of Binderburg R&D, whose current focus seems to be on the development of a new form of drone specializing in [Information has been restricted]`,
        sourceUrl: 'https://starborne.com/post/binderburg_lore_part1',
    },
    {
        title: 'Gelecek - History',
        slug: 'gelecek_pt2',
        body: `## History:
...
In recent years Gelecek has continued to flaunt its exclusive tech, moving research stations instantly from one side of the galaxy to the other, and effortlessly bypassing Binderburg's continued efforts to keep them away from the mechanisms. In addition to their smaller scale staples of android development and personal modifications, the company has continued to pursue its research into the galaxy's most unexplained phenomenon, an obsession that has steadily led them further towards the Spiral Expanse, and the edge of the known Frontier.`,
        sourceUrl: 'https://starborne.com/post/gelecek_pt2',
    },
    {
        title: 'Gelecek - Background Briefing',
        slug: 'gelecek_pt1',
        body: `## Executive Summary:
...
As Everliving continues to publicly deny control of the Marauders, it is difficult to ascertain how many leashed Marauders may remain and what plans they may be enacting for their Child masters. The prevalence of the wild variety clouds the waters, as they act independently and follow no plan but destruction and their own perpetuation. However, organizations dedicated to tracking patterns in Marauder movement have recently noticed an abnormal surge in activity near the Gamish Waypoint at the edge of the Spiral Expanse. Whether this is indicative of an Everliving plot or merely the natural result of the target rich environment caused by new colonists bridging into the waypoint, remains to be seen.`,
        sourceUrl: 'https://starborne.com/post/marauders_pt2',
    },
    {
        title: 'Marauders - Background Briefing',
        slug: 'marauders_pt1',
        body: `## Executive Summary:
...
Marauders are famed for their disregard of life, both for their victims and among their own. Lacking the ability to innovate their own tech, Marauders will use whatever equipment they come across until it begins to fall apart, and their tactics are designed to inflict maximum damage on their targets through sheer brute force. Prisoners are often modified and imprinted, unwillingly absorbed into their captors' crew. Some Marauder packs have approached a degree of self-sufficiency using this strategy, replenishing resources via raiding and conquering outlying stations, while largely ignoring planets.`,
        sourceUrl: 'https://starborne.com/post/marauders_pt1',
    },
    {
        title: 'Everliving - History',
        slug: 'everliving_pt2',
        body: `## History:
...
[Further information has been restricted]`,
    ...
    {
        title: 'Everliving - Background Briefing',
        slug: 'everliving_pt1',
        body: `## Executive Summary:
...
On a mechanical level, Everliving's ships and stations are built first and foremost to survive. Their fleets consist of highly defensive and hardy capital ships (to safeguard their valuable agents, partners, and research) that are often accompanied by swarms of fiercely loyal, expendable escort vessels. Much of their technology is uniquely capable of withstanding hostile space environments avoided by other factions, such as the Deadzones, and their life support systems are second to none in efficiency.`,
        sourceUrl: 'https://starborne.com/post/everliving_pt1',
    },
    {
        title: 'XAOC - History',
        slug: 'xaoc_pt2',
...
The Frontier of the Spiral Expanse, with its unregulated space and fledgling colonies, is no exception. Far away from the militaries of the major blocs, many colonies are easy pickings for XAOC, and they have flooded into the region en masse. Besides the major Houses, there are also any number of upstart organizations and splinter groups seeking dominance through raiding operations and resources, with some even specializing in the slave trade.`,
        sourceUrl: 'https://starborne.com/post/xaoc_pt2',
    },
    {
        title: 'XAOC - Background Briefing',
        slug: 'xaoc_pt1',
        body: `## Executive Summary:
...
While this latest project has caused an informal ceasefire between the Combine and its old rivals in Atlas and the MPL, it is undeniable that tension over the division of space, resources, and contracts remain. While the Combine continues to provide one of the best avenues of employment for those looking to escape the inner systems, they remain on edge, alert for both raiders and corporate agents that might step in the way of their worker's prosperity.`,
        sourceUrl: 'https://starborne.com/post/terran_combine_pt2',
    },
    {
        title: 'Terran Combine - Background Briefing',
        slug: 'terran_combine_pt1',
        body: `## Executive Summary:
...
Despite these hiccups, in recent years the Syndicate has managed to continue their vast operations across the galaxy mostly unimpeded. However, their expansion efforts have now turned decidedly towards consolidating their presence in the Omega Sector and pushing towards the Spiral Expanse. There, Atlas has focused their efforts towards contracting out their financial, military, and information brokering services to independent colonies and commanders, while also turning their eyes towards corners of the market currently held by smaller corporations, such as the Binderburg Conglomerate and Gelecek.`,
        sourceUrl: 'https://starborne.com/post/atlas_pt2',
    },
    {
        title: 'Atlas Syndicate - Background Briefing',
        slug: 'atlas_pt1',
        body: `## Executive Summary:
...
This skill is supplemented by access to some of the most advanced scanning systems in the galaxy. In combat, Atlas forces are supported by one of the finest logistical teams in human history, alongside some of the best equipment money can buy, giving them a lot of versatility. Earned or not, the confidence of Atlas commanders is unmatched.`,
        sourceUrl: 'https://starborne.com/post/atlas_pt1',
    },
    {
        title: 'Mars Prosper League - History',
        slug: 'mpl-pt2',
        body: `## History:
...
The latest colonization effort has seen the opening of long range bridges towards the Spiral Expanse, where densely clustered systems and vast clouds of interstellar gas promise vast resources and big margins.`,
        sourceUrl: 'https://starborne.com/post/mpl-pt2',
    },
    {
        title: 'Mars Prosper League - Background Briefing',
        slug: 'mpl-pt1',
        body: `## Executive Summary:
...
Armed with massive industrial vehicles, swarms of extractor drones, and legions of uniformed miners and engineers, when the MPL arrives, nothing but grime and dust is left behind.

Initially lured in by the promise of a life of opportunity among the stars, MPL workers often end up indentured into service through a series of complex debt arrangements. Overseeing these uniform, expendable masses, is a class of competent middle managers and bureaucrats. While well-situated, they amount to little more than cogs in the machine that is the MPL, often receiving the same pressure from above as they exert on those below them.

The League's top shareholders and executives lead a life of supreme decadence: mansions the size of palaces, luxury spacecraft, and stations lined with platinum. The MPL elite adopt a personal style that oozes wealth and class.

The pinnacle of it all is the station Karat, which serves as the seat for the MPL's Board of Directors. An array of massive pillars extending from a central nexus and interconnected by a series of rings, the entire station is encrusted with natural diamonds from across the galaxy, and bathed in the red glow of the Dyson-caged sun it orbits.
...
Still, the profitability and material riches of their installations make the League a prime target for various raiders and pirate factions. As a result, the MPL focuses its strategic doctrine on defensive warfare, developing ships and technologies that excel at holding the line and buying time until a sufficient force can gather to crush any assault.`,
        sourceUrl: 'https://starborne.com/post/mpl-pt1',
    },
    {
        title: 'Frontier Legion - History',
        slug: 'frontier-legion-pt2',
        body: `## History:
...
In recent years, the Legion has been involved in opening many new sectors for human colonization, while the major political blocs are distracted with their perpetual warfare. After becoming one of the Factions involved in the Omega-project in 2412, it has recently spent considerable resources on a new expedition to firmly establish its presence in the Spiral Expanse. The 7th, 15th, and 24th legions have been slated to participate.`,
        sourceUrl: 'https://starborne.com/post/frontier-legion-pt2',
    },
    {
        title: 'Frontier Legion - Background Briefing',
        slug: 'froniter_legion_pt1',
        body: `## Executive Summary:
...
In particular, Legion troops are outfitted with cutting edge armor: fully functional inside of an atmosphere as well as in the vacuum of space. The Legion's counter-insurgency tactics are legendary, with only XAOC strike teams rivaling their ability to board and control enemy vessels. However, whereas XAOC is likely to strip a captured ship clean and enslave its crew, the Frontier Legion abides by its own strict sense of societal responsibility, and commitment to official legal processes.`,
        sourceUrl: 'https://starborne.com/post/froniter_legion_pt1',
    },
    {
...
"Coffee," he says. "Black."`,
        sourceUrl: 'https://starborne.com/post/omega-project-bar-flies',
    },
    {
        title: 'Tau Scorpii Historical Server',
        slug: 'tau-scorpii-historical-server',
        body: `## The following is based on actual gameplay that took place within the Tau Scorpii-historical server whose result has now been incorporated into the Starborne universe.

Major participating alliances included, (but not limited to), the following:
...
"It is with great pride that I announce our victory in Tau Scorpii. This is another step forward on the march towards liberty. I want to congratulate our forces on the frontline. All of you are part of something greater today. But let us not forget the martyrs who gave their lives over the course of the campaign. Let us celebrate the hundreds of worlds liberated. Let us thank every patriot for their sacrifice. We are now working to secure our position across the central cluster and reinforce our holdings in the wider region. Meanwhile, we will continue to provide our researchers with whatever resources they need to delve into the secrets of these gravitational mechanisms. This war is not over. Let us seize the momentum of this victory and carry it forward to greater heights. Thank you, and may justice and liberty prevail."
...
While these events may have concluded the fighting within the inner zone of Tau Scorpii, the blocs are still at war. The campaign has transformed into a multi-front battle for control of the wider region (colloquially called 'the gardens'). History, as it always has, continues to unfold before us.`,
        sourceUrl: 'https://starborne.com/post/tau-scorpii-historical-server',
    },
    {
...
To you, poor child of Earth, the moon's scars are as shadows,and our dust shines like silver.To me, daughter of Luna, your blue waters are untaintedby the blood of fallen man.
...
Energy-tech Revolution and Sol Dyson ProjectThe existence of AAI-calculations unlocked a new era of technological progress that led to rapidly shifting economic and social paradigms. As new principles in physics were applied, old industries were replaced with new, and populations thrived.Developments in negative energy formation led to the invention of the Tenebris-Rosen-Bridge-Generator (TRB-Generator), a device capable of manipulating space-time in an effort to facilitate FTL transport. At first these "bridges" were limited by the incredible amounts of energy required, and initial efforts at extrasolar exploration were stymied.

Faster Than LightThe first activation of an experimental TRB-Generator in 2192 resulted in the death of 117 scientists when their station's hull was ruptured by a collapse in the containment field. It would not be until 2208 that the first manned TRB shuttle made the passage through an FTL bridge, traveling from Jupiter to a docking station near Earth in just under twenty minutes.
...
"I just hope I'm recalled to duty in time to pay them back sir," she says. "For Admiral Tanee, and for everyone else we've lost." "Cadet, I will do everything in my power to right this injustice. On that you have my word."Returning the cadet's crisp salute, the First Citizen watches as the young woman exits the room. Ziv closes the simulcast with a close-up of Laurent's impassioned gaze. "We're finished sir."Laurent releases a long, slow breath. "She did well, for one so young," he says, reaching into the pocket of his jacket to produce a vial of Allay. He dabs the thick gel with the tip of his finger and proceeds to rub it onto his temple. Its modified enzyme goes to work through the skin, serving to ease tension while simultaneously acting as a harmless stimulant to the cerebral dopaminergic system. Ziv is aware of its effects on him immediately. "I too was impressed," the avatar says. Their voice is a reflection of their child form: young and bright, but offset by a certainty of diction and tone no eight year old has ever possessed. "What's next on the agenda?" he asks.

"A briefing with the admiralty sir, but I believe you knew that.""I did. All the same, it helps to hear these things out loud.""I am aware of that sir, as I believe you are aware.""Ziv, with you I sometimes feel like I'm speaking in circles.""Likewise sir.""This produces a bitter laugh from Laurent. "We grew complacent Ziv.""You have your faults sir, but complacency was never among them.""I'm speaking of the collective Ziv. The Directorate. Certain of our own primacy, we allowed an insurrection to simmer for years, and then acted surprised when it finally boiled over. And now the Martians sense an opportunity. You heard the speech that pompous grandstander Asverald delivered to the Assembly?"

"Of course sir.""Every projection indicates we've reached an inflection point. It is a dangerous moment Ziv. One wrong move, and we could lose everything. Without strong leadership, Lunar leadership, humanity could descend into barbarism. We must be very careful."Laurent turns quiet.
...
"The Directorate must adapt Ziv," he says"Yes sir.""Increased investment in military infrastructure. The further reorganization of our public works projects and educational practices. A more streamlined decision-making process. But I suppose you've already come to the same conclusions yourself.""I have sir."Laurent turns to face Ziv."And when were you planning to inform me?""When the information was needed, as it was now.""Do I need to ask if you've compiled a list of our needs for the admiralty?""Asking implies a lack of knowledge. I believe you're fully aware sir." "What would I do without you?""You'd do fine sir. You're very capable for a human." The First Citizens lets out another laugh, this one genuine."Let's get to it then, shall we?Laurent strides from the room. Following at a respectful distance, Ziv's face is blank.`,
        sourceUrl: 'https://starborne.com/post/executive-assistant',
    },
    {
...
"To the Peers of the Assembly, to the people of the Commonwealth, I make this solemn promise: we stand against those extremists who seek to impose their political agenda upon the universe. The Commonwealth protects the rights and self-determination guaranteed to its members under the Charter of Mars!"`,
        sourceUrl: 'https://starborne.com/post/the-speakers-promise',
    },
    {
        title: 'Light Sleeper',
        slug: 'light-sleeper',
        body: `"Fire renews the forest, revolution the people."
...
She nearly choked on the words: "He talked in his sleep."`,
        sourceUrl: 'https://starborne.com/post/light-sleeper',
    },
    {
        title: 'Dissidence - Prologue',
        slug: 'dissidence-prologue',
        body: `A lot of good people died today. Commander Aliyah Khan, my first officer, trapped in engineering as the plasma fires raged. Marrat Acharya, chief engineer, blown into space as the docking bay breached. 22 others at last count. Given my own injury report, I might soon be joining them.
...
Tau Scorpii, 24/09/2411`,
        sourceUrl: 'https://starborne.com/post/dissidence-prologue',
    },
];
