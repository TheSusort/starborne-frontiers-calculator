...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'Battle simulator: charged skills whose targeting or hit area differs from the active skill now use the charged targeting and footprint on the turn they fire.',
    ...
    "Skill parsing fixes: Cultivator's active skill now actually cleanses a debuff (a game-data text typo was hiding it), Morao's active Provoke now carries its correct 1-turn duration (previously missing), and Madax's active skill now includes its base damage hit alongside the existing Defense-scaled bonus damage.",
