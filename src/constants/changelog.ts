...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'Healing Calculator: ships that react to enemy repairs and cleanses — Zosimos, Arum, Yarrow, Larkspur, and Grif — now fire correctly when the enemy uses a repair or cleanse skill.',
