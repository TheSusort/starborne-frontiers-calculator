...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Upgrade analysis: the coverage grid's target pieces per slot is now adjustable.",
    ...
    "Combat simulator: a stolen Protection stack no longer taxes Lionheart's next round.",
    "Combat simulator: the skill editor's named-status field now accepts multi-word names.",
    'Combat simulator: Panguan, Centurion and Judge now scale with the real board count.',
    "Combat simulator: Panon's Barrier now arms when he is damaged, not on his turn.",
    "Combat simulator: Tormenter's adjacent damage buff now stops at his neighbours.",
    'Combat simulator: buffs for adjacent allies now reach them, not the caster.',
    "Combat simulator: Chimei's refit passive now filters its repair and Stealth targets.",
    'Combat simulator: passive and reactive repairs now proc Font of Power and Abundant Renewal.',
    'Combat simulator: Abundant Renewal now shields a healer that over-repairs itself.',
    'Combat simulator: a leech now counts as a full repair everywhere.',
    "Combat simulator: an over-repair redirect no longer applies the healer's repair bonuses twice.",
    'Combat simulator: a critical repair on yourself now triggers crit-repair passives.',
    'Combat simulator: Font of Power now procs on self-repairs too.',
    'Combat simulator: stacking buffs granted to allies now accrue on them.',
    'Combat simulator: the same stacking buff from two sources now banks both.',
    "Combat simulator: Chimei's over-repair redirect now fires, pooling all waste into one repair.",
    'Combat simulator: repair and shield rows now name what was wasted.',
    "Combat simulator: Hayyan's charged skill now performs its 17% Max HP repair.",
    'Combat simulator: damage converted into a DoT is now credited to you.',
    'Combat simulator: a converting ally no longer inflates your team damage.',
    'Combat simulator: a leech now pays off what the hit actually did.',
