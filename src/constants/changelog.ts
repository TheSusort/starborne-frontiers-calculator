...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'Gear analysis: flags Supporters and Boosters missing their Repair or Boost set piece.',
];
...
export const CHANGELOG: ChangelogEntry[] = [
    ...
    },
    {
        ...
        date: '2026-09-10',
        changes: [
            'Autogear: a new Custom mode builds a role from the stats you pick.',
            'Autogear: a new Direct Damage stat, and Effective HP now works as a bonus.',
            'Autogear: stat priority rows no longer carry reorder arrows.',
            ...
            'Upgrade analysis: priority now compares against a typical good piece, not the best.',
            'Upgrade analysis: coverage grid preferences are now kept per account.',
            'Ship inventory: your list or image view choice now survives a reload.',
            'Factions: Tianchao is now called Tianchen, matching the game.',
            ...
            'Combat simulator: roughly two dozen engine fixes across repairs, buffs, Protection and damage over time.',
        ],
    },
    {
        version: '1.66.0',
