...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat simulator now models conditional incoming-damage-reduction implants and gear sets: Voidshade and Shadowguard (reduced damage while stealthed), Nebula Nullifier (reduced damage while in Stasis), Hyperion Gaze and Hardened set (reduced incoming critical-hit damage), Iridium's passive (reduced crit damage taken, scaling with rarity), Vortex Veil (reduced Inferno and Corrosion damage), and Ironclad (a chance to block a repeat hit from the same attacker). Ships with these equipped now take less damage when the relevant conditions are met.",
];
