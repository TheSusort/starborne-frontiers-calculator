...
export const UNRELEASED_CHANGES: string[] = [
    'Combat engine: ships with an "extra end of round action" passive (such as Harvester) now take that extra turn at the very end of the round, after every other ship has acted, instead of being re-inserted at their Speed position. Default extra actions (Liberator, Nuqtu, and the like) still act at their Speed position as before.',
