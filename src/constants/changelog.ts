...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'Combat simulator and calculators: Fuying\u2019s Stasis counter now waits for an ally who is actually in Stealth, as her skill says. \u201cWhen an ally in Stealth within the active pattern is directly damaged, this Unit inflicts Stasis for 1 turn onto the enemy\u201d was ignoring the Stealth half entirely and firing on any ally being hit. On a test board where nobody on the team was Stealthed at all it still handed out 20 Stasis over 20 rounds; it now hands out none. Where it does belong, nothing has been taken away: Stealth a Tianchao ally, let an enemy area attack catch that ally, and the enemy is put in Stasis \u2014 on every qualifying hit, since the skill sets no limit. Being hit does not strip Stealth, so an ally can keep answering hit after hit. Enemy Fuyings punish your attacks on their Stealthed allies the same way.',
    'Combat simulator and calculators: Fuying\u2019s passive now actually protects Stealthed Tianchao allies. \u201cAll Tianchao allies with Stealth take 30% less direct damage\u201d was doing nothing at all \u2014 every other damage-reduction passive in the game protects the ship carrying it, so a reduction meant for OTHER ships had nowhere to go and was silently dropped. Put Fuying on the board, Stealth a Tianchao ally standing inside her targeting pattern, and a 10,000-damage hit on that ally now lands for 7,000. Being Stealthed does not stop a ship being hit \u2014 it only stops the enemy choosing it \u2014 so this comes up constantly: an area attack aimed at someone else still catches the Stealthed ally, and now it hurts less. Three things it deliberately does not cover: an ally standing OUTSIDE her pattern takes the full hit, a XAOC ally inside it takes the full hit, and Damage over Time ticks are unreduced because the skill says \u201cdirect damage\u201d. Fuying herself gains nothing from it, since her own Stealth grant never includes her. At refit 2 and 3 the reduction is 15% instead of 30%. Enemy Fuyings protect their own side the same way.',
    'Combat simulator and calculators: Fuying\u2019s Stealth now goes only to Tianchao allies, as her skill says. \u201cGrants Tianchao allies Stealth for 1 turn\u201d was reaching every ally the skill covered, and Stealth is what makes a ship untargetable \u2014 so this was not a number being a little high, it was allies the enemy could not shoot at all. Only 14 of the 149 ships are Tianchao, so on a typical five-ship team most of the allies protected were ships that should never have been. Cast it now with a Tianchao ally and a XAOC ally both inside her pattern and only the Tianchao one goes into Stealth; the other stays a valid target. Her companion Security Up III grant is untouched \u2014 it still reaches everyone the pattern covers. Enemy Fuyings get the same treatment against you. In the skill editor, any ally-targeted buff can now be given a recipient faction of your own, alongside the ship\u2019s targeting pattern.',
    'Combat simulator and calculators: Fuying’s charged skill now cleanses more than 1 debuff when her crit power is high enough. The skill text says it cleanses a debuff “for every 50% crit power this Unit has,” matching Amartya’s identically-worded purge, but the scaling was being discarded and she always cleansed exactly 1 regardless of crit power. A Fuying at 150% crit power now cleanses 3 debuffs instead of 1; below 50% crit power she cleanses 0, as the clause reads literally.',
    'Combat simulator and calculators: Fuying’s charged skill now also extends Stealth by 1 turn, as the second half of its text says. That clause was producing no effect at all. It reaches every ally in her targeting pattern — unlike her Stealth grant, it names no faction, so a non-Tianchao ally standing inside the pattern is extended too, while an ally standing outside it, Tianchao or not, gets nothing. Only Stealth’s own remaining duration grows; any other timed buff the same ally is holding is left alone. In a fight: Fuying Stealths an ally for 1 turn on her active, and the following turn her charged skill lands and makes it 2 — the ally stays untargetable, and keeps the damage-reduction aura, for an extra round.',
    'Ship data refresh: Fuying and Prophet join the roster, and Zosimos\u2019s skills have been reworked in game. The new text exposed four faults, all fixed. Prophet did nothing at all: both its skills deal damage equal to a multiple of its Security (50x, and 120x when charged), a form no other ship uses and one the game-text reader could not read, so the ship was built with no attack whatsoever and sat there for the whole fight. It now attacks for what its Security says it should. Its passive was also handing it a free extra action every single round \u2014 roughly doubling its output \u2014 when the skill only grants one in reaction to resisting a debuff. Fuying\u2019s passive, which makes Tianchao allies in Stealth take less damage, was being read as a 30% attack on the enemy: a defensive aura had become an extra offensive hit. And Zosimos\u2019s charged skill was inventing a repair worth 300% of its own maximum health, because the status it inflicts is called \u201cReversed Repairs\u201d and the word \u201cRepairs\u201d in that name was mistaken for an instruction to repair, then paired with the 300% belonging to the damage clause \u2014 nine status names in the game contain the word \u201cRepair\u201d, so this could have struck any of them. Zosimos\u2019s charge stripping now also happens when the enemy repairs, as the skill says, rather than when Zosimos casts. Still not modelled and tracked separately: Prophet\u2019s Shield Penetration growing as allies resist debuffs. (Fuying\u2019s damage reduction for Stealthed Tianchao allies is now modelled \u2014 see the entry above.)',
