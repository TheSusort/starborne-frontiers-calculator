...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'Healing Calculator: added a per-round Healer Output overview (mirrors the DPS round breakdown). For the best config it lists, round by round, the direct heal, heal-over-time, shield granted, effective vs overheal, cleanses, and the incoming damage / target HP% it faced — with charged and crit badges.',
];
