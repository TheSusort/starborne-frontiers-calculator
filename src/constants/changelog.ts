...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Battle simulator: Faust now purges buffs from whoever kills it — but only on a killing blow from a direct attack. When Faust is destroyed by a direct hit it strips buffs (2, or 3 on its later refit) from the ship that landed the kill; a death from damage-over-time ticks no longer triggers the purge.",
