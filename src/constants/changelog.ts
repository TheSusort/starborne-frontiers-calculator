...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat simulator: Quixilver's refit passive now works. At the end of its turn, if its Shield is at 100% of its max health, it gives the whole team a Barrier and puts them on a 3-turn Barrier Recharging cooldown; once that cooldown runs out the next full-Shield turn gives the team a fresh Barrier. Previously the passive did nothing at all, and the cooldown was only a name in the buff list.",
    'Combat simulator: a Barrier granted "for 1 hit" is now used up by the hit it blocks instead of lasting the rest of the fight. This affects Malvex, Panon, Quixilver and Sansi. Barriers granted for a number of turns are unchanged, and a Bomb going off does not use up a hit charge.',
