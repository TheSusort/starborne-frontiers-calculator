...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'DPS Calculator: the old Combat Settings panel is now split into separate Enemy Settings and Team sections you can open independently, and the damage chart legend marks team (“with team”) lines with a dashed swatch so they’re easy to tell apart from the solid attacker lines.',
];
