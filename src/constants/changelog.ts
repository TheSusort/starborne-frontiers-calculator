...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat simulator: DoTs inflicted by a reaction are now real DoTs. Ruiner's Bomb, and Warden's and Shepherd's Corrosion, used to land as a name-only status on the wrong unit — they never ticked, never counted down and never exploded. They now land on the enemy that triggered them, tick and burst for real damage, and Ruiner's Bomb still respects its once-per-round-per-enemy cap.",
