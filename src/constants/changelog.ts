...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat simulator now models three outgoing-damage amplification implants: Menace (chance to amplify a hit's damage), Giant Slayer (chance to amplify a hit's damage on a critical hit or against an enemy with higher attack), and Insidiousness (chance to deal bonus damage when you apply a debuff to an enemy).",
];
