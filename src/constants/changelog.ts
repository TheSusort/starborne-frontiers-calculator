...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'DPS simulator overhaul: crits now follow a deterministic per-round schedule instead of an averaged multiplier (crit rounds shown with a "Crit" badge in the chart tooltip), ability conditions actually gate damage, DoTs, and detonations so unmet conditions contribute nothing that round, enemy HP declines as damage accumulates so "below X% HP" execute-style effects kick in mid-fight, and results are fully reproducible run-to-run. Skill abilities now execute in skill-text order and can be reordered in the editor.',
];
