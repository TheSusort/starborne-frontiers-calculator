...
export const UNRELEASED_CHANGES: string[] = [
    ...
    'DPS Calculator skill auto-fill now gates "X% more damage when its HP is below Y%" modifiers (e.g. Los) on a self HP-threshold, instead of applying the bonus unconditionally.',
