...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Healing Calculator: the per-round healer output now lives in the timeline chart's hover card (matching the DPS calculator) — hover any round to see that round's direct heal, heal-over-time, shield granted, effective vs overheal, cleanses, and the incoming damage / target HP% it faced, with charged and crit badges. The Enemy Effects breakdown is now a hover-gated panel beside the chart that shows the hovered round's per-enemy self-buffs and the debuffs or DoTs landed on the target.",
];
