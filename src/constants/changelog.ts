...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat sim: reactive Damage-over-Time effects (like Crocus's on-ally-crit Corrosion) now land on the enemy the triggering ally actually hit, so they deal damage to your real opponents instead of being lost. This also removes a phantom 'enemy' entry that could appear at the end of a round in team battles showing an inflated Corrosion/Inferno tick.",
