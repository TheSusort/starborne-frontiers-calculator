...
export const UNRELEASED_CHANGES: string[] = [
    'Vindicator\u0027s on-resist retaliation now fires once per ATTACK it resists, not once per round. An enemy skill that strikes twice and has its debuff resisted on both strikes now takes two hits of 30% of Vindicator\u0027s Max HP instead of one \u2014 the second was being swallowed. A single attack that applies two debuffs still retaliates once, which was already correct and is unchanged. Applies on both your ships and the enemy\u0027s.',
