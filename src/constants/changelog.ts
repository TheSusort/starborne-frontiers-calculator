...
export const UNRELEASED_CHANGES: string[] = [
    'Renamed the "Others" targeting category to "Other Allies" for clarity, and corrected Faust and Refine, whose support skills exclude the caster (the caster now shows the gray excluded marker on their footprints).',
    'Ship Database and Ships pages can now be filtered and searched by skill targeting — two new multi-select filters let you narrow to ships whose skills hit a specific target selection (Front, Back, Skip, All, Self, Team, Other Allies) or AoE pattern shape. The free-text search box on both pages also matches targeting terms (e.g. typing "cone" or "backline").',
