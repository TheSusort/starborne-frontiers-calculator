...
export const UNRELEASED_CHANGES: string[] = [
    ...
    "Combat sim: fixed round-boundary and start-of-combat timing for several ships. Judge's execute damage, Chimei's Stealth-gated repair, Incinerator's Inferno damage, Chakara's speed-based follow-up hit, Rhodium's co-located damage, and Nayra/Isha's Affinity Override buffs now fire at the actual start/end of the round instead of being folded into the ship's own turn. Crucialis, FrontLine, Tycho, and Yazid's start-of-combat Shield/buff/Cheat Death grants are now applied once before the battle begins, instead of re-applying every time the ship acts.",
];
