        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.averageDamage! - currentSimulation.averageDamage!) /
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.effectiveHP! - currentSimulation.effectiveHP!) /
      ...
      <div>
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(suggestedSimulation.damageReduction! - currentSimulation.damageReduction!).toFixed(
                1
              )}
              %)
            </span>
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.attacksWithstood! - currentSimulation.attacksWithstood!) /
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.hackSuccessRate! - currentSimulation.hackSuccessRate!) /
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.averageHealing! - currentSimulation.averageHealing!) /
        ...
        <span className="ml-2">
          ...
          {isComparison && suggestedSimulation && (
            ...
            >
              (
              {(
                ((suggestedSimulation.highestHeal! - currentSimulation.highestHeal!) /
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-gray-200">
      ...
      {suggestedSimulation && (
        <div className="bg-dark p-4 rounded space-y-2">
          ...
          <div className="flex flex-col gap-2">{renderStats(suggestedSimulation, true)}</div>
        </div>
      )}
    </div>
  );
