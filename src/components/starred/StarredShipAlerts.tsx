...
export const StarredShipAlerts: React.FC = () => {
    ...
    if (minimized) {
        return (
            <button
                ...
                className="fixed bottom-4 right-4 z-40 flex items-center gap-1.5 bg-dark border border-dark-border rounded-lg px-3 py-2 text-theme-text hover:bg-dark-lighter transition-colors"
    ...
    return (
        <div className="fixed bottom-4 right-4 z-40 w-72 sm:w-80 bg-dark border border-dark-border rounded-lg shadow-lg flex flex-col max-h-80">
