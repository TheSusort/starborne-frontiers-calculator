                    ...
                    {activeSuggestions.map((suggestion, index) => {
                        ...
                        return (
                            <div
                                ...
                                className="bg-dark-lighter border border-dark-border rounded p-4 hover:border-primary transition-colors"
                            >
                                <div className="flex justify-between items-start mb-2">
                                    ...
                                    {onSelectSuggestion && (
                                        <button
                                            ...
                                            className="px-4 py-2 bg-primary text-dark rounded hover:bg-primary/90 transition-colors text-sm font-medium"
                                        >
                                            Use in Calculator
                                        </button>
                                    )}
