                        ...
                        <div className="card">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-theme-text mb-4">
                                    ...
                                    form. Tweaks carry no reorder controls: every tweak is scored
                                    independently of the others, so list position makes no
                                    difference.
                                </p>
                            ...
                            <div className="p-4 bg-dark-lighter">
                                ...
                                <ol className="text-theme-text list-decimal pl-4 space-y-1">
                                    <li>
                                        ...
                                        applied equation) — a Custom-mode formula can be shared
                                        whether it&apos;s started from a role or built entirely from
                                        scratch, and a build using Crit Multiplier can be shared too
                                    </li>
                                    <li>
