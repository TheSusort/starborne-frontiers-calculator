            ...
            <div className="max-w-4xl mx-auto">
                <div className="mb-8">
                    <p className="text-gray-300 mb-6">
                        ...
                        between them. Upload your exported player data files to analyze differences
                        in units, equipment, and engineering.
                    </p>
                </div>
                ...
                <div className="bg-dark border border-dark-border p-6 mt-6">
                    ...
                    <div className="space-y-3 text-gray-300">
                        ...
                        <p>
                            <strong>Large Files (≥5MB):</strong> Optimized comparison focusing on
                            key Starborne Frontiers sections:
                        </p>
                        <ul className="list-disc list-inside ml-4 space-y-1">
                            ...
                            <li>
                                <strong>Engineering:</strong> Level, Type, Attribute, and
                                ModifierType changes
                            </li>
                        </ul>
                        <p className="text-sm text-gray-400 mt-4">
                            Equipment changes are grouped with their equipped units for better
                            readability. Detailed Attributes fields are excluded to reduce verbosity
                            in large files.
                        </p>
                    </div>
                </div>
