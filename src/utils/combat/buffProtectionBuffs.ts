 ...
 *  Purge-only: cleanse (debuff removal) and buff-steal (PR10, statusEngine.steal) are
 *  unaffected — confirmed/tested at src/utils/combat/__tests__/buffSteal.test.ts. Holder-state
 *  guard, NOT a per-buff property (cf. UNREMOVABLE_STATUSES). Extend from game data as identified. */
